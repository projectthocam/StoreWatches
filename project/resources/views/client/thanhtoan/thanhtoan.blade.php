...
<form class="woocommerce-form woocommerce-form-login login" method="post" style="display:none;" data-bitwarden-watching="1">
	...
	<p class="form-row">
		<input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="c5022d280b"><input type="hidden" name="_wp_http_referer" value="/donghohaitrieu/thanh-toan/">		<button type="submit" class="button" name="login" value="Đăng nhập">Đăng nhập</button>
		<input type="hidden" name="redirect" value="http://mauweb.monamedia.net/donghohaitrieu/thanh-toan/">
		<label class="woocommerce-form__label woocommerce-form__label-for-checkbox inline">
			<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever"> <span>Ghi nhớ mật khẩu</span>
		</label>
	</p>
	<p class="lost_password">
		<a href="http://mauweb.monamedia.net/donghohaitrieu/tai-khoan/lost-password/">Quên mật khẩu?</a>
	</p>
...
<form class="checkout_coupon woocommerce-form-coupon has-border is-dashed" action="{{route('Submit')}}" method="post" style="display:none">
...
<form name="checkout" method="post" class="checkout woocommerce-checkout " action="http://mauweb.monamedia.net/donghohaitrieu/thanh-toan/" enctype="multipart/form-data" novalidate="novalidate" data-bitwarden-watching="1">
...
<div class="woocommerce-additional-fields">
  ...
  <table class="shop_table woocommerce-checkout-review-order-table">
    ...
    <tbody>
      <tr class="cart_item">
        <td class="product-name">{{number_format($cart['item']['price']*$cart['qty'], 0, ',', ',')}}&nbsp;
  ...
  <div id="payment" class="woocommerce-checkout-payment">
    ...
    <div class="form-row place-order">
      ...
      <input type="hidden" id="woocommerce-process-checkout-nonce" name="woocommerce-process-checkout-nonce" value="25e35ae838">
    </div>
  </div>
</div>
												@endforeach
